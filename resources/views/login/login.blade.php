...
<div class="grid place-items-center h-screen ">
        <div class="h-auto py-4 w-[450px] border border-gray-500 rounded-md bg-white font-serif shadow-md font-bold">
            ...
            <div class="w-[80%] m-auto mb-3 ">
                ...
                <input type="Text" name="uname" placeholder="Enter email or username " class="w-[100%] bg-transparent text-sm rounded-md border-none focus:ring-0">
            ...
            <div class="w-[80%] m-auto mb-2">
                ...
                <input type="password" name="pass" placeholder="Enter password " class="w-[100%] text-sm rounded-md border-none focus:ring-0">
